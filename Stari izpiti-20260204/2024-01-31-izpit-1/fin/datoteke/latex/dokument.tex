...
Naj bo $D \subseteq \R$. Funkcija $f : D \to \R$ je \emph{funkcija prvega Bairovega razreda}, 
...
Klasične primere najdemo v \cite{counterexamples}

% začetek zgleda
\begin{zgled}[Thomaeova funkcija]
    Funkcijsko zaporedje $f_n :(0,1) \to \R$ definiramo na sledeč način.
    ...
    $$f(x)=\begin{cases}
        \frac{1}{p}; & x=\frac{p}{q}\ \text{je pokrajšan ulomek za} p,q \in \mathbb{N} \\
