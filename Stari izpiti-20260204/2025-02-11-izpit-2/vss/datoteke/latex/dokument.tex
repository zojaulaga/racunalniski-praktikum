...
% Matej Rojec
% 2025-01-29
\newcommand{\parc}[1]{\frac{\partial {#1}}{\partial {\bigstar}}}
...
% začetek enačbe
    ...
    % \left\{
    % začetek
    % \parc{U} = \frac{\sigma^2}{2}S^2 \frac{\partial^{2} {S}}{\partial {U}^{2}} + rS \parc{U} - rU  \textnormal{in } \mathcal{R}^T_V
